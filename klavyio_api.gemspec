...
Gem::Specification.new do |spec|
  spec.name          = 'klaviyo_api'
  spec.version       = KlaviyoAPI::VERSION
  spec.authors       = ['rewind.io']
  spec.email         = ['team@rewind.io']

  spec.summary       = "Consume Klaviyo's API using ActiveResource"
  spec.description   = "Consume Klaviyo's API using ActiveResource"
  spec.homepage      = 'https://github.com/rewindio/klaviyo_api.git'
  spec.license       = 'MIT'
